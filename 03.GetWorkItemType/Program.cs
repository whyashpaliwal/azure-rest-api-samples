        ...
        public static async Task<bool> GetProjects(){
            try{  
                ...
                using (HttpClient client = new HttpClient()){    
                    ...
                    using (HttpResponseMessage response = await client.GetAsync("https://dev.azure.com/TopTeamIntegration/TestingAgile/_apis/wit/workitemtypes?{name}&api-version=5.1"))
                    {
                        //exception handling
